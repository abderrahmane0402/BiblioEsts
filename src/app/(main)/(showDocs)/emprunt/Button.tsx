...
export const Button = ({ name }: { name: string }) => {
  ...
  return (
    <button
      ...
      } w-24 text-lg py-2 rounded-md bg-transparent hover:bg-black hover:text-white duration-500 transition-colors`}
    >
...
export const Button2 = ({ name }: { name: string }) => {
  ...
  return (
    <button
      ...
      } w-24 text-lg py-2 rounded-md bg-transparent hover:bg-lime-600 hover:text-white duration-500 transition-colors`}
    >
...
export const Button3 = ({ name }: { name: string }) => {
  ...
  return (
    <button
      ...
      } w-24 text-lg py-2 rounded-md bg-transparent hover:bg-red-700 hover:text-white duration-500 transition-colors`}
    >
